...
async def to_code(config):
    ...
    if CONF_NONAUTHORISED_CARD_UID in config:
        sens = await text_sensor.new_text_sensor(config[CONF_NONAUTHORISED_CARD_UID])
        cg.add(var.set_nonauthorised_uid_sensor(sens))